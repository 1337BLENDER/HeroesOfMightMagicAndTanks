...
public class CharactersAbilitiesService {
    ...
    @Autowired
    public CharactersAbilitiesService(CharactersAbilitiesRepository charactersAbilitiesRepository){this.charactersAbilitiesRepository=charactersAbilitiesRepository;}
     ...
     */
    public CharactersAbilities getById (int id){return charactersAbilitiesRepository.findOne(id);}
    ...
    public Iterable<CharactersAbilities> getAllByCharacter(Characters character){return charactersAbilitiesRepository.findAllByCharacter(character);}
    ...
    public Iterable<CharactersAbilities> getAll(){return charactersAbilitiesRepository.findAll();}
    ...
    public CharactersAbilities saveOrUpdate(CharactersAbilities charactersAbilities){return charactersAbilitiesRepository.save(charactersAbilities);}
    ...
    public void deleteById(int id){charactersAbilitiesRepository.delete(id);}

    /**
     * Remove all the charactersAbilities entities
     */

    public void deleteAll(){charactersAbilitiesRepository.deleteAll();}
    ...
    public void delete(CharactersAbilities charactersAbilities){charactersAbilitiesRepository.delete(charactersAbilities);}
}
