...
public class UnitsInArmyService {
    ...
    @Autowired
    public UnitsInArmyService(UnitsInArmyRepository unitsInArmyRepository) {
        this.unitsInArmyRepository = unitsInArmyRepository;
    }
    ...
    public UnitsInArmy saveOrUpdate(UnitsInArmy unitsInArmy) {
        return unitsInArmyRepository.save(unitsInArmy);
    }
    ...
    public void deleteById(int id) {
        unitsInArmyRepository.delete(id);
    }
    ...
    public void deleteAll() {
        unitsInArmyRepository.deleteAll();
    }
    ...
    public void delete(UnitsInArmy unitsInArmy) {
        unitsInArmyRepository.delete(unitsInArmy);
    }
}
