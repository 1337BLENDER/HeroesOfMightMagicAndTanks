...
public class BuildingsService {
    ...
    @Autowired
    public BuildingsService(BuildingRepository buildingRepository) {
    ...
    public Buildings getById(int id) {
    ...
    public Buildings getByName(String name) {
    ...
    public Iterable<Buildings> getAll() {
    ...
    public Buildings saveOrUpdate(Buildings Building) {
    ...
    public void delete(Buildings Building) {
