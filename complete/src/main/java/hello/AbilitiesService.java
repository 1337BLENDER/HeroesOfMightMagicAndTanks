...
public class AbilitiesService {
    ...
    @Autowired
    public AbilitiesService(AbilitiesRepository abilityRepository){this.abilityRepository=abilityRepository;}
     ...
     */
    public Abilities getById (int id){return abilityRepository.findOne(id);}
    ...
    public Abilities getByName (String name){return abilityRepository.findByName(name);}
    ...
    public Abilities saveOrUpdate(Abilities Ability){return abilityRepository.save(Ability);}
    ...
    public void deleteById(int id){abilityRepository.delete(id);}
    ...
    public void deleteByName(String name){abilityRepository.deleteByName(name);}

    /**
     * Remove all the abilities
     */

    public void deleteAll(){abilityRepository.deleteAll();}
    ...
    public void delete(Abilities Ability){abilityRepository.delete(Ability);}
}
